...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://talentservicesprofilear.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://talentservicesidentityar.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
